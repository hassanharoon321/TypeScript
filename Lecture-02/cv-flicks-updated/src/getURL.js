...
class LinkedInPage extends Component {
  ...
  handleSuccess = (data) => {
    ...
    console.log("gfghhff", this.state.data)
  }
  ...
  callbackLinkedIn = (error, code, redirectUri) => {
    if (error) {
      ...
      console.log("ppppppppp",code,redirectUri)
  ...
  callCheck=()=>{
    ...
    console.log("llllll",propss);
    // fetch('https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id={your_client_id}&redirect_uri={your_callback_url}&state=foobar&scope=r_liteprofile%20r_emailaddress%20w_member_social',
    // 'GET',

    // ).then(res=>res.json()).then(res=>{

    // }).catch(e=>{
    //   console.log("lin err",e);
    // })
  }
  ...
  render() {
    ...
    return (
      <div>
        ...
        text={<img src={Linked} alt="Log in with Linked In" style={{ maxWidth: '180px' }} />}
        >
