...
function PersonalDetailsLogin(props) {
  ...
  const handleCountry = (e) => {
    ...
    var selectedCountry = props.personalloginReducer.personal.countries.filter(
                  ...
                  <div className="row">
                    <div className="col-md-5">
                      ...
                      >
                        ...
                        {props.personalloginReducer.personal.countries &&
                          props.personalloginReducer.personal.countries.length > 0 ? (
                          props.personalloginReducer.personal.countries.map((con) => (
                            <option value={con.id}>
