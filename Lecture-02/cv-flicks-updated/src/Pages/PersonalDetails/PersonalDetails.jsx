...
function PersonalDetails(props) {
  ...
  useEffect(() => {
    ...
    console.log("gggg", props.personalReducer);
  }, []);
  ...
  const handleCountry = (e) => {
    ...
    var selectedCountry = props.personalReducer.personal.countries.filter((c) => c.id === e.target.value);
    
    if (selectedCountry.length > 0) {
      var city = selectedCountry[0].cit;
      console.log(city);
          ...
          <div className="row">
            ...
            <div className="col-md-5">
              ...
              >
                ...
                {props.personalReducer.personal.countries &&
                props.personalReducer.personal.countries.length > 0
                  ? props.personalReducer.personal.countries.map((con) => (
                      <option value={con.id}>
