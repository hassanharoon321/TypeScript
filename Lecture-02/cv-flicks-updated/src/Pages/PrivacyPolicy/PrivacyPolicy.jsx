  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <h3>Usage and Information Collection by CV Vlogs</h3>
        <p>
        ...
        <p>
          ...
          information is linked to your personally identifiable information.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            administer payments and process your credit card information when
            you purchase our products & services. We also use a third party
            service provider to host our website as well as serve you with our
            newsletters via email. These service providers are not authorized to
            use your personally identifiable information for their promotional
            purposes.
          </li>
          <li>
            We disclose information if legally required to do so, if requested
            to do so by a governmental entity or if we believe in good faith
            that such action is necessary to: (a) conform to legal requirements
            or comply with legal process such as in complying with a judicial
            ...
            national security; or (d) protect the personal safety of users or
            the public.
          </li>
          <li>
            ...
            we become the subject of a bankruptcy proceeding, whether voluntary
            or involuntary, we or our trustee in bankruptcy may sell, license or
            otherwise dispose of such information in a transaction approved by
            the bankruptcy court. In the event of any such circumstances, you
            will be notified via email or through a prominent notice posted on
            the CV Vlogs Website.
          </li>
          <li>
            ...
            party web site the information collected here is governed by CV
            VLOGS and our privacy practices.
          </li>
        </ul>
        <h3>Personal Information on Resumes and Profiles</h3>
        <p>
        ...
        <p>
          ...
          resumes or profiles in these instances.
        </p>
        <h3>Posting to Public Areas of CV Vlogs</h3>
        <p>
        ...
        <p>
          ...
          to a specific page. For example, if you personalize CV Vlogs pages,
          or register for services, a cookie helps us to recall your specific
        ...
        <p>
          ...
          webmaster at'support@Cvvlogs' or by calling customer support at
          0800-****). These points of contact also allow you to edit your
        ...
        <h3>Security of the Profile Information</h3>
        <p>
        ...
        <h3>Children's use of CV Vlogs</h3>
        <p>
        ...
        <p>
          ...
          based corporation with its principal place of business at
          xxxxxxxxxxxxxxxxxxx and certain of its affiliated companies worldwide,
          do business. Scorpius Holding LLC. is the legal entity which
          determines the purposes and means of processing the information
          gathered at www.CV Vlogs.com. You can also contact us at support@CV
          Vlogs.com.
        </p>
        <h3>Refund Policy</h3>
        <p>
          ...
          to CV Vlogs or any payment is provided to CV
        </p>
        <p>
          Flicks in excess of the amount payable or due by the Client, CV Vlogs
          may at its sole discretion :
        </p>
        <ul className="mb-2">
          <li>
            Adjust the amount against future payments payable by the Client to
            CV Vlogs; or
          </li>
          <li>
            Provide a refund to the Client after deduction of applicable 10%
            refund processing fee(s).
          </li>
        </ul>
        <p>
