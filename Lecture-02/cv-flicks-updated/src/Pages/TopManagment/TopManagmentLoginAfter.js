...
import { getTopManagementAfter } from "../../actions/topManagmentAfterAction";
        ...
        <div className=" mt-5">
          ...
          <div className="row pt-3">
            <div className="col-md-12 pb-5">
              <h1 className="top-managment-jobs-head font-weight-bold" style={{ color: "#865ddd" }}>
                Recent Jobs
              </h1>
              <p className="showing-99-jobs font-weight-bold" style={{ color: "#011F95" }}>
                Showing{" "}
          ...
          <div className="row mt-3">
            ...
            <div className="col-md-2" style={{ background: "#D8E8FF", borderRadius: "15px", height: "900px" }}>
              <div className="placeholder-for-ads mt-5" style={{ writingMode: "vertical-rl", textOrientation: "mixed",fontSize:"40px" }}>Placeholder for Ads</div>
            </div>
          </div>
          {/* Managment Ends */}
        </div>
...
const mapDispatchToProps = (dispatch) => ({
  getTopManagementAfter: (userId) => dispatch(getTopManagementAfter(userId)),
});
export default connect(mapStateToProps, mapDispatchToProps)(TopManagmentLoginAfter);
