                        ...
                        {props.uploadCvVideoReducer.uploadCvVideo.videos ? (
                            props.uploadCvVideoReducer.uploadCvVideo.vids_allowed >
                                ...
                                <>
                                    ...
                                    <p className="text-center" style={{ color: "#707070" }}>In order to protect your privacy, we strongly recommend that you do not share any personal data, i.e. full name, home address, phone number, email address in your resume video.</p>
                                    <div className="row">
                                    ...
                                    (getVid) => (
                                        <div className="col-md-12 text-center" key={getVid.video_id}>
                                            {/* <img
                                                ...
                                                src={
                                                    getVid.thumbnail !== null &&
                                                        getVid.thumbnail !== undefined
                                                        ? getVid.thumbnail
                                                        : ""
                                                }
                                            /> */}
