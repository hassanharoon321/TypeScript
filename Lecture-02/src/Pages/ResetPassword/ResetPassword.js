                        ...
                        <div className="row" >
                            ...
                            <div className="col-lg-6 col-md-8">
                                <div className="shadow p-4" style={{ borderRadius: "15px", background: "#fff" }}>
                                    ...
                                    <p className="text-center mb-3" style={{ color: "#707070" }}>You are setting up a new password for your cvflicks account linked with particular email</p>
