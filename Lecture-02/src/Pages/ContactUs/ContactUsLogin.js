...
import { postContactUs } from "../../actions/contactUsLoginAction";
...
function ContactUsLogin(props) {
    ...
    const createContact = async () => {
        await props.postContactUs(localStorage.getItem("auth_id"), name, email, message)
    }
...
const mapDispatchToProps = (dispatch) => ({
    postContactUs: (userId, name, email, message) => dispatch(postContactUs(userId, name, email, message))

});
export default connect(mapStateToProps, mapDispatchToProps)(ContactUsLogin);
