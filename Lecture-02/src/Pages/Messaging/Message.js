    ...
    return (
      ...
      >
        <div className="row">
          ...
          <div className="col-md-12">
            <p className=" text-center pt-2">Do you want to report {this.state.userName}?</p>
          </div>
          <div className="col-md-12">
            <div className="row">
              <div className="col-md-4"></div>
              <div className="col-md-2">
                <a href="#" ><h5 className="text-danger text-center" onClick={() => this.reportMeassage()}>Yes</h5></a>
              </div>
              <div className="col-md-2">
                <a href="#" className="text-dark"> <h5 className="text-center" onClick={()=>this.setState({reportModal:false})}>No</h5></a>
              </div>
              <div className="col-md-4"></div>
            </div>
          </div>
      ...
      >
        <div className="row">
          ...
          <div className="col-md-12">
            <p className=" text-center pt-2">Do you want to delete chat with {this.state.userName}?</p>
          </div>
          <div className="col-md-12">
            <div className="row">
              <div className="col-md-4"></div>
              <div className="col-md-2">
                <a href="#" ><h5 className="text-danger text-center" onClick={()=>this.deleteMeassage()}>Yes</h5></a>
              </div>
              <div className="col-md-2">
                <a href="#" className="text-dark"> <h5 className="text-center" onClick={()=>this.setState({deleteModal:false})}>No</h5></a>
              </div>
              <div className="col-md-4"></div>
            </div>
          </div>
